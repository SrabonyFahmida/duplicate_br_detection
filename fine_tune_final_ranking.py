...
bug_reports = read_json_objects_as_strings('/home/fhossain/replication_package/0_data/0_bug report collection/corpus and queries/accumulo/preprocessed_test.json')
bug_report_ids = []
bug_report_texts = []
...
ground_truth_data = read_ground_truth('/home/fhossain/replication_package/0_data/0_bug report collection/corpus and queries/accumulo/GT_for_placeholders.json')
...
output_file_path = '/home/fhossain/replication_package/0_data/0_bug report collection/corpus and queries/accumulo/RAanking_output.txt'  # Update file path
